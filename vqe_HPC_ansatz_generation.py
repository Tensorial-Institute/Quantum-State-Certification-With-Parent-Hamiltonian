...
def parse_args():
    ...
    p.add_argument("--tries", type=int, default=3, help="number of full hardware runs repeats (best kept)")
...
# ============================================================
# find_best_dicke_ansatz loop (progressively increasing entanglers)
# ============================================================
SAVE_THRESHOLDS = [
    (0.05,   "_firstbelow005"),
    (0.03,   "_firstbelow003"),
...
def find_best_dicke_ansatz(num_qubits: int, numk: int, rng_seed: int, try_idx: int = 0):
...
if __name__ == "__main__":
    ...
    for try_idx in range(tries):
        exp_list, parameters_history, cand_circuit, cand_params, cand_theta, cand_fun = find_best_dicke_ansatz(
